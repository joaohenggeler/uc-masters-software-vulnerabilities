...
CREATE PROCEDURE BUILD_FUNCTION_DATASET(IN METRICS_TABLE VARCHAR(20), IN OUTPUT_CSV_PATH VARCHAR(3000))
BEGIN
	...
	SET @QUERY = CONCAT(
		'(SELECT 	"Description", "COMMIT_HASH", "COMMIT_DATE", "COMMIT_YEAR", "VULNERABILITY_CVE", "VULNERABILITY_YEAR",
					"VULNERABILITY_CWE", "VULNERABILITY_CATEGORY", ', @METRICS_COLUMNS, ', "ELIGIBLE_FOR_ALERTS", "TOTAL_ALERTS", ', @ALERT_COLUMNS,
		')
