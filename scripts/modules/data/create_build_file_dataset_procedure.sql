...
BEGIN
	...
	SET @QUERY = CONCAT(
		'(SELECT 	"Description", "COMMIT_HASH", "COMMIT_DATE", "COMMIT_YEAR", "VULNERABILITY_CVE", "VULNERABILITY_YEAR",
					"VULNERABILITY_CWE", "VULNERABILITY_CATEGORY", ', vMETRICS_COLUMNS, ', "COMMIT_HAS_ALERTS", "TOTAL_ALERTS", ', vALERT_COLUMNS,
		')
	    ...
	    LEFT JOIN
		(
			SELECT A.ID_File, COUNT(*) AS TOTAL_ALERTS, ', vALERT_COUNT,
			'FROM ALERT A
