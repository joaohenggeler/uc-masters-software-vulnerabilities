			...
			try:
				cursor.execute(	'''
									...
									(
										...
										CountPath, FanIn, FanOut, AvgFanIn,
										AvgFanOut, MaxFanIn, MaxFanOut,
								...
								(
									...
									# @TODO: Map these missing None values to their respective columns in the CSV files.
									row['CountPath'], row['CountInput'], row['CountOutput'], None,
									None, None, None,
									None, None, None,
									None, row['MaxInheritanceTree'], row['CountClassDerived'], None,
